          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 class="header2">Information Update</h4>
                <div class="row">
                  <form class="col s12" action="success.php" method="post">
                    <div class="row">
                      <div class="input-field col s6">
                        <input id="first_name" name="first_name" type="text" placeholder=<?php $_SESSION['name2'] = $_SESSION['name']; echo $_SESSION['name2'];?> >
                        <label for="first_name">Name</label>
                      </div>
                      
                      <div class="input-field col s6">
                        <input id="weight" type="text" name="weight" placeholder=<?php $_SESSION['weight2'] = $_SESSION['weight']; echo $_SESSION['weight2']; ?> >
                        <label for="weight">weight</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="input-field col s12">
                        <input id="email5" type="text" name="height" placeholder=<?php $_SESSION['height2'] = $_SESSION['height']; echo $_SESSION['height2']; $_SESSION['career2'] = 0; ?> >
