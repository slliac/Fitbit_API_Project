                    ...
                    <li class="user-details cyan darken-2">
                        <div class="row">
                            ...
                            <div class="col col s8 m8 l8">
                                ...
                                <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown"><?php echo $_SESSION["loginedName"];?></a>

                            </div>
                        </div>
                    </li>
    <li class="bold"><a href="first.php" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i>Index</a></li>
    <li class="bold"><a href="mail.php?page=Friend" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i>Mail Page</a></li>
              ...
              <div id="profile-page-sidebar" class="col s12 m4">
                ...
                <ul id="profile-page-about-details" class="collection z-depth-1">
                  <li class="collection-item">
                    <div class="row">
                      <div class="col s5 grey-text darken-1"><i class="mdi-action-perm-identity"></i> Weight </div>
                      <div class="col s7 grey-text text-darken-4 right-align"><?php echo $_SESSION["searchHeight"]; ?></div>
                    </div>
                  </li>
                  <li class="collection-item">
                    <div class="row">
                      <div class="col s5 grey-text darken-1"><i class="mdi-action-perm-identity"></i> Height</div>
                ...
                <div id="profile-page-wall-share" class="row">
                  <div class="col s12">
                   ...
                   <div id="UpdateStatus" class="tab-content col s12  grey lighten-4">
                     ...
                     <?php
                        echo '<form action= "success5.php" method="post">';
                      ?>
                ...
                <div id="profile-page-wall-posts"class="row">
                      ...
                      <div id="profile-page-wall-post" class="card">
                        <div class="card-profile-title">
                            <div class="col s10">
                              <p class="grey-text text-darken-4 margin"><?php echo "The Physical amount of sport compared with ",$_SESSION["searchName"],"(blue) and You(",$_SESSION["loginedName"],")(green)";?></p>
                            </div>
                            <div class="col s1 right-align">
                ...
                <ul>
                  ...
                  <li><a href="app-email.html" class="btn-floating blue"><i class="large mdi-communication-email"></i></a></li>
                      ...
                      <div id="profile-page-wall-post" class="card">
                        <div class="card-profile-title">
                            <div class="col s10">
                              <p class="grey-text text-darken-4 margin"><?php echo "The Cardio Activation of sport compared with ",$_SESSION["searchName"],"(orange) and You(",$_SESSION["loginedName"],")(red)";?></p>
                            </div>
                            <div class="col s1 right-align">
                              <i class="mdi-navigation-expand-more"></i>
                            </div>
