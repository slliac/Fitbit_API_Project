...
var text = '{"activeMinute":"10" ,"CaloriesOut":"15","distance":"20"}';
var obj = JSON.parse(text);
var active = parseInt(obj.activeMinute);
var co = parseInt(obj.CaloriesOut);
var distance = parseInt(obj.distance);


var trendingLineChart;
var data = {
	labels : ["Active Minute","Calories Out","Distance"],
	datasets : [
		{
			label: "First dataset",
...
*/
var radarChartData = {
	labels: ["Active", "Very Active", "Moderate Active", "lightly active", "sedentary active","total"],
	datasets: [
		{
			label: "First dataset",
