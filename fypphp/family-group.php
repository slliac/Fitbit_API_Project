            ...
            <div id="profile-page-header" class="card">
                ...
                <div class="card-content">
                  <div class="row">                    
                    ...
                    <h4 class="card-title grey-text text-darken-4"><?php echo $_SESSION['name'];?></h4>
                    <p class="medium-small grey-text">Gender: <?php echo $_SESSION['gender'];?></p>
                    </div>
                    <div class="col s2 center-align">
                        <h4 class="card-title grey-text text-darken-4"><?php echo $_SESSION['user_age'];?></h4>
                        <p class="medium-small grey-text">User age</p>
                    </div>
                    <div class="col s2 center-align">
                        <h4 class="card-title grey-text text-darken-4"><?php echo $_SESSION['family_name'];?> </h4>
                        <p class="medium-small grey-text">Family joined</p>
                    </div>                    
                    <div class="col s2 center-align">
                        <h4 class="card-title grey-text text-darken-4"><?php echo $_SESSION['weight'];?></h4>
                        <p class="medium-small grey-text">Weight</p>
                    </div>
                ...
                <div class="card-reveal">
                    <p>
                      <span class="card-title grey-text text-darken-4"><?php echo $_SESSION['name'];?><i class="mdi-navigation-close right"></i></span>
                      <span><i class="mdi-action-perm-identity cyan-text text-darken-2"></i><?php echo $_SESSION['gender'];?></span>
                    </p>
                    ...
                    <div id="UpdateStatus" class="tab-content col s12  grey lighten-4">
                      ...
                      <div class="row">
                        ...
                        <div class="col s12 m6 right-align">
                            ...
                            <a class="waves-effect waves-light btn"><i class="mdi-maps-rate-review left"></i>Update your profile</a>
                        </div>
                      </div>
                    </div>
                    <!-- AddPhotos -->
