...
$fb_user_id = $_POST['target_user_id']; //receiver
$receiver = $_POST['target_user_name'];
...
$message = $sender . ' would like to invite you';
$title = 'Friend request';


$result = mysqli_query($db->con, "INSERT INTO message(name, post_name, message, type, title, isread) VALUES('$receiver', '$sender', '$message', 'friend_request', '$title', false )") or die(mysqli_error($db->con));
...
$msg = array
(
	'message' 	=> $sender . ' would like to add you',
	'title'		=> $title,
	'subtitle'	=> $receiver,
	'tickerText'	=> 'text',
  'type' => 'friend_request',
