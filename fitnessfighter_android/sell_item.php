...
$result = mysqli_query($db->con, "UPDATE equity_box SET equipment_id = '-1', fb_user_id = null WHERE familyName = '$familyName' AND position = '$position'") or die(mysqli_error($db->con));
